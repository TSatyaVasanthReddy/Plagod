            ...
            <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
              ...
              <div class="mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                ...
                <div class="mdl-card__actions">
                  <a href="${course.alternateLink}" class="mdl-button">Open in classroom</a>
                </div>
              </div>
              <button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored mdl-shadow--4dp mdl-color--accent" id="add" onclick="openassignment(${course.getId()},${course.name})">
    ...
    <!-- <div id="assignment">
      <form class="assignment-form" method="post" action="testwebapp2/formcheck" commandName="userForm">
        ...
        <div class="form-details">
          ...
          <input type="text" path="instruction" placeholder="Instruction (optional)" id="">
          ...
          <input type="checkbox" path="plagiarismCheck" id="plagiarismCheck" onclick="toogleplagiarism()">do you want plagiarism check?<br>
